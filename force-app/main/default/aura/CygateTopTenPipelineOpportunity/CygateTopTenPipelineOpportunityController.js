/**
 * Description:
 * Aura component implements a list of the Top 10 most valuable open Cygate Opportunities, 
 ...
 *                component and use its functions. handleFilterChanges introduced to retrieve Opportunities
 *                upon filter value changes.
*/
({
      /**
       * Description:
       * Retrieve the Top 10 (or fewer) most valuable open Opportunities,
      ...
      doInit : function(component, event, helper) {
            helper.helperRetrieveOpportunities( component, 
                "c.getlistofpipelinedopportunitycygate",
