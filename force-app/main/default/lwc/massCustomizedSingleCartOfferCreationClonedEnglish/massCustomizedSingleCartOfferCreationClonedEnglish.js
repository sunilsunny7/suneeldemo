...
import { OMNIDEF } from './massCustomizedSingleCartOfferCreationClonedEnglish_def.js';
import tmpl from './massCustomizedSingleCartOfferCreationClonedEnglish.html';
import tmpl_nds from './massCustomizedSingleCartOfferCreationClonedEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedSingleCartOfferCreationClonedEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
