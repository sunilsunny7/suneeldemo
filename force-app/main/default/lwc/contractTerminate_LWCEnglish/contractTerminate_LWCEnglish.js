...
import { OMNIDEF } from './contractTerminate_LWCEnglish_def.js';
import tmpl from './contractTerminate_LWCEnglish.html';
import tmpl_nds from './contractTerminate_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class contractTerminate_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
