...
import { OMNIDEF } from './utilizerBreakoutEnglish_def.js';
import tmpl from './utilizerBreakoutEnglish.html';
import tmpl_nds from './utilizerBreakoutEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class utilizerBreakoutEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
