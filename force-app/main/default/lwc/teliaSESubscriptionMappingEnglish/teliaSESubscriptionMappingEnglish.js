...
import { OMNIDEF } from './teliaSESubscriptionMappingEnglish_def.js';
import tmpl from './teliaSESubscriptionMappingEnglish.html';
import tmpl_nds from './teliaSESubscriptionMappingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class teliaSESubscriptionMappingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
