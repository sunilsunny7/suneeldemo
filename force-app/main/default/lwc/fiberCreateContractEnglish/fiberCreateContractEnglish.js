...
import { OMNIDEF } from './fiberCreateContractEnglish_def.js';
import tmpl from './fiberCreateContractEnglish.html';
import tmpl_nds from './fiberCreateContractEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fiberCreateContractEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
