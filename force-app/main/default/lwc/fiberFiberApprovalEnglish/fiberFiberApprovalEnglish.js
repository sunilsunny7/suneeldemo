...
import { OMNIDEF } from './fiberFiberApprovalEnglish_def.js';
import tmpl from './fiberFiberApprovalEnglish.html';
import tmpl_nds from './fiberFiberApprovalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fiberFiberApprovalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
