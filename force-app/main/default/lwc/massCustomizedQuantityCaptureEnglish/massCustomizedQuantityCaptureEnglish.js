...
import { OMNIDEF } from './massCustomizedQuantityCaptureEnglish_def.js';
import tmpl from './massCustomizedQuantityCaptureEnglish.html';
import tmpl_nds from './massCustomizedQuantityCaptureEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedQuantityCaptureEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
