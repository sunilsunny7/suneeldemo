...
import { OMNIDEF } from './massCustomizedSingleCartOfferCreation_AEnglish_def.js';
import tmpl from './massCustomizedSingleCartOfferCreation_AEnglish.html';
import tmpl_nds from './massCustomizedSingleCartOfferCreation_AEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedSingleCartOfferCreation_AEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
