...
import { OMNIDEF } from './massCustomizedApprovalEnglish_def.js';
import tmpl from './massCustomizedApprovalEnglish.html';
import tmpl_nds from './massCustomizedApprovalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedApprovalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
