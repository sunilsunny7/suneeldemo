...
import { OMNIDEF } from './massCustomizedRevise_LWCEnglish_def.js';
import tmpl from './massCustomizedRevise_LWCEnglish.html';
import tmpl_nds from './massCustomizedRevise_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedRevise_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
