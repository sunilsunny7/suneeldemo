...
import { OMNIDEF } from './createContractDocumentEnglish_def.js';
import tmpl from './createContractDocumentEnglish.html';
import tmpl_nds from './createContractDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class createContractDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
