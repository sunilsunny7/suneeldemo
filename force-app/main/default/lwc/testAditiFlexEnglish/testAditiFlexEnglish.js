...
import { OMNIDEF } from './testAditiFlexEnglish_def.js';
import tmpl from './testAditiFlexEnglish.html';
import tmpl_nds from './testAditiFlexEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testAditiFlexEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
