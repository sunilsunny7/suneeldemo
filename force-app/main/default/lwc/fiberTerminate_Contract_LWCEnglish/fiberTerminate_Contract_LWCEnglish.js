...
import { OMNIDEF } from './fiberTerminate_Contract_LWCEnglish_def.js';
import tmpl from './fiberTerminate_Contract_LWCEnglish.html';
import tmpl_nds from './fiberTerminate_Contract_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fiberTerminate_Contract_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
