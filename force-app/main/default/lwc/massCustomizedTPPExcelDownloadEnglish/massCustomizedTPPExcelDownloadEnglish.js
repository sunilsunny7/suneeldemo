...
import { OMNIDEF } from './massCustomizedTPPExcelDownloadEnglish_def.js';
import tmpl from './massCustomizedTPPExcelDownloadEnglish.html';
import tmpl_nds from './massCustomizedTPPExcelDownloadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedTPPExcelDownloadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
