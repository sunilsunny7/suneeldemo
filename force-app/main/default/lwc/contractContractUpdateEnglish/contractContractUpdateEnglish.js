...
import { OMNIDEF } from './contractContractUpdateEnglish_def.js';
import tmpl from './contractContractUpdateEnglish.html';
import tmpl_nds from './contractContractUpdateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class contractContractUpdateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
