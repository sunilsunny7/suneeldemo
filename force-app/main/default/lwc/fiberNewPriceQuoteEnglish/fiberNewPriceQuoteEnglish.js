...
import { OMNIDEF } from './fiberNewPriceQuoteEnglish_def.js';
import tmpl from './fiberNewPriceQuoteEnglish.html';
import tmpl_nds from './fiberNewPriceQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fiberNewPriceQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
