...
import { OMNIDEF } from './documentContractDocumentEnglish_def.js';
import tmpl from './documentContractDocumentEnglish.html';
import tmpl_nds from './documentContractDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class documentContractDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
