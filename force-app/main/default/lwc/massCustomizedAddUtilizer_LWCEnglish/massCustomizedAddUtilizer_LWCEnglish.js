...
import { OMNIDEF } from './massCustomizedAddUtilizer_LWCEnglish_def.js';
import tmpl from './massCustomizedAddUtilizer_LWCEnglish.html';
import tmpl_nds from './massCustomizedAddUtilizer_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedAddUtilizer_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
