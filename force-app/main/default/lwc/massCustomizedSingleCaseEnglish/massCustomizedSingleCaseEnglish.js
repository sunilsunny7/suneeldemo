...
import { OMNIDEF } from './massCustomizedSingleCaseEnglish_def.js';
import tmpl from './massCustomizedSingleCaseEnglish.html';
import tmpl_nds from './massCustomizedSingleCaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedSingleCaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
