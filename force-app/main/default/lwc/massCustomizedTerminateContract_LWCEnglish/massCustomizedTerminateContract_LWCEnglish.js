...
import { OMNIDEF } from './massCustomizedTerminateContract_LWCEnglish_def.js';
import tmpl from './massCustomizedTerminateContract_LWCEnglish.html';
import tmpl_nds from './massCustomizedTerminateContract_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedTerminateContract_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
