...
import { OMNIDEF } from './subscriptionCart_LWCEnglish_def.js';
import tmpl from './subscriptionCart_LWCEnglish.html';
import tmpl_nds from './subscriptionCart_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class subscriptionCart_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
