...
import { OMNIDEF } from './preCheckReviewEnglish_def.js';
import tmpl from './preCheckReviewEnglish.html';
import tmpl_nds from './preCheckReviewEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class preCheckReviewEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
