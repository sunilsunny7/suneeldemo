...
import { OMNIDEF } from './warmupDCApiCacheLoadConfigurationEnglish_def.js';
import tmpl from './warmupDCApiCacheLoadConfigurationEnglish.html';
import tmpl_nds from './warmupDCApiCacheLoadConfigurationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class warmupDCApiCacheLoadConfigurationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
