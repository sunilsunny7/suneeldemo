...
import { OMNIDEF } from './fiberContractRenegotiationEnglish_def.js';
import tmpl from './fiberContractRenegotiationEnglish.html';
import tmpl_nds from './fiberContractRenegotiationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fiberContractRenegotiationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
