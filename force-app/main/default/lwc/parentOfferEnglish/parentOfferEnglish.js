...
import { OMNIDEF } from './parentOfferEnglish_def.js';
import tmpl from './parentOfferEnglish.html';
import tmpl_nds from './parentOfferEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class parentOfferEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
