...
import { OMNIDEF } from './testFlexcardQuantityCaptureEnglish_def.js';
import tmpl from './testFlexcardQuantityCaptureEnglish.html';
import tmpl_nds from './testFlexcardQuantityCaptureEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testFlexcardQuantityCaptureEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
