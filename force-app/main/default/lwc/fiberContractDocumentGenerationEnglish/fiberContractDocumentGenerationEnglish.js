...
import { OMNIDEF } from './fiberContractDocumentGenerationEnglish_def.js';
import tmpl from './fiberContractDocumentGenerationEnglish.html';
import tmpl_nds from './fiberContractDocumentGenerationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fiberContractDocumentGenerationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
