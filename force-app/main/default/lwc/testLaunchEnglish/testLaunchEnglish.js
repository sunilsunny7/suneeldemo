...
import { OMNIDEF } from './testLaunchEnglish_def.js';
import tmpl from './testLaunchEnglish.html';
import tmpl_nds from './testLaunchEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testLaunchEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
