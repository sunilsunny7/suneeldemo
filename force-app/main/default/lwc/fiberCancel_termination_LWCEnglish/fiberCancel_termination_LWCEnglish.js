...
import { OMNIDEF } from './fiberCancel_termination_LWCEnglish_def.js';
import tmpl from './fiberCancel_termination_LWCEnglish.html';
import tmpl_nds from './fiberCancel_termination_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fiberCancel_termination_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
