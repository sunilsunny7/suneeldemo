...
import { OMNIDEF } from './massCustomizedQuantityCapture_AbhinavtestEnglish_def.js';
import tmpl from './massCustomizedQuantityCapture_AbhinavtestEnglish.html';
import tmpl_nds from './massCustomizedQuantityCapture_AbhinavtestEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedQuantityCapture_AbhinavtestEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
