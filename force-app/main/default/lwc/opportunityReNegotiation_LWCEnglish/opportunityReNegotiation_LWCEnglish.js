...
import { OMNIDEF } from './opportunityReNegotiation_LWCEnglish_def.js';
import tmpl from './opportunityReNegotiation_LWCEnglish.html';
import tmpl_nds from './opportunityReNegotiation_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class opportunityReNegotiation_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
