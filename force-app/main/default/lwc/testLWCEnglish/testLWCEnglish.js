...
import { OMNIDEF } from './testLWCEnglish_def.js';
import tmpl from './testLWCEnglish.html';
import tmpl_nds from './testLWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testLWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
