...
import { OMNIDEF } from './fiberOrderunderlagEnglish_def.js';
import tmpl from './fiberOrderunderlagEnglish.html';
import tmpl_nds from './fiberOrderunderlagEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fiberOrderunderlagEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
