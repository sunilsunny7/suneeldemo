...
import { OMNIDEF } from './testFileUPloadEnglish_def.js';
import tmpl from './testFileUPloadEnglish.html';
import tmpl_nds from './testFileUPloadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testFileUPloadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
