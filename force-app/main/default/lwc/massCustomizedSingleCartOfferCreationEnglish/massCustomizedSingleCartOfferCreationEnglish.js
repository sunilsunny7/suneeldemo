...
import { OMNIDEF } from './massCustomizedSingleCartOfferCreationEnglish_def.js';
import tmpl from './massCustomizedSingleCartOfferCreationEnglish.html';
import tmpl_nds from './massCustomizedSingleCartOfferCreationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedSingleCartOfferCreationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
