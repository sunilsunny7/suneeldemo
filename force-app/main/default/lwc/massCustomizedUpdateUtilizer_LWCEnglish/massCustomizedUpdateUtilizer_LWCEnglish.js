...
import { OMNIDEF } from './massCustomizedUpdateUtilizer_LWCEnglish_def.js';
import tmpl from './massCustomizedUpdateUtilizer_LWCEnglish.html';
import tmpl_nds from './massCustomizedUpdateUtilizer_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedUpdateUtilizer_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
