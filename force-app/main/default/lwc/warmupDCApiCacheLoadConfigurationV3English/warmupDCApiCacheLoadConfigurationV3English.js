...
import { OMNIDEF } from './warmupDCApiCacheLoadConfigurationV3English_def.js';
import tmpl from './warmupDCApiCacheLoadConfigurationV3English.html';
import tmpl_nds from './warmupDCApiCacheLoadConfigurationV3English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class warmupDCApiCacheLoadConfigurationV3English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
