...
import { OMNIDEF } from './documentQuoteDocumentEnglish_def.js';
import tmpl from './documentQuoteDocumentEnglish.html';
import tmpl_nds from './documentQuoteDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class documentQuoteDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
