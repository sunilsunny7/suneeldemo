...
import { OMNIDEF } from './massCustomizedCreateSA_LWCEnglish_def.js';
import tmpl from './massCustomizedCreateSA_LWCEnglish.html';
import tmpl_nds from './massCustomizedCreateSA_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedCreateSA_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
