...
import { OMNIDEF } from './guidedSellingEnglish_def.js';
import tmpl from './guidedSellingEnglish.html';
import tmpl_nds from './guidedSellingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class guidedSellingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
