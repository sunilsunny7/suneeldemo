...
import { OMNIDEF } from './massCustomizedSingleCart_coflowEnglish_def.js';
import tmpl from './massCustomizedSingleCart_coflowEnglish.html';
import tmpl_nds from './massCustomizedSingleCart_coflowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedSingleCart_coflowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
