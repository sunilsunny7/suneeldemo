...
import { OMNIDEF } from './fiberQuoteGenerationEnglish_def.js';
import tmpl from './fiberQuoteGenerationEnglish.html';
import tmpl_nds from './fiberQuoteGenerationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fiberQuoteGenerationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
