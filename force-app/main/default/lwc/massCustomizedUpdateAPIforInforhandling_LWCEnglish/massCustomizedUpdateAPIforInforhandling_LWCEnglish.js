...
import { OMNIDEF } from './massCustomizedUpdateAPIforInforhandling_LWCEnglish_def.js';
import tmpl from './massCustomizedUpdateAPIforInforhandling_LWCEnglish.html';
import tmpl_nds from './massCustomizedUpdateAPIforInforhandling_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedUpdateAPIforInforhandling_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
