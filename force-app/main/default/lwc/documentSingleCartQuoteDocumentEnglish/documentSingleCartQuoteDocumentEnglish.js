...
import { OMNIDEF } from './documentSingleCartQuoteDocumentEnglish_def.js';
import tmpl from './documentSingleCartQuoteDocumentEnglish.html';
import tmpl_nds from './documentSingleCartQuoteDocumentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class documentSingleCartQuoteDocumentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
