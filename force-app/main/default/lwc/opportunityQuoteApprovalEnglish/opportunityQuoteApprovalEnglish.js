...
import { OMNIDEF } from './opportunityQuoteApprovalEnglish_def.js';
import tmpl from './opportunityQuoteApprovalEnglish.html';
import tmpl_nds from './opportunityQuoteApprovalEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class opportunityQuoteApprovalEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
