...
import { OMNIDEF } from './testClearOSDataTestClearOSDataEnglish_def.js';
import tmpl from './testClearOSDataTestClearOSDataEnglish.html';
import tmpl_nds from './testClearOSDataTestClearOSDataEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testClearOSDataTestClearOSDataEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
