...
import { OMNIDEF } from './fiberQuoteDocumentGenerationEnglish_def.js';
import tmpl from './fiberQuoteDocumentGenerationEnglish.html';
import tmpl_nds from './fiberQuoteDocumentGenerationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fiberQuoteDocumentGenerationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
