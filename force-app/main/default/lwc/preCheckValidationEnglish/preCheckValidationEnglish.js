...
import { OMNIDEF } from './preCheckValidationEnglish_def.js';
import tmpl from './preCheckValidationEnglish.html';
import tmpl_nds from './preCheckValidationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class preCheckValidationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
