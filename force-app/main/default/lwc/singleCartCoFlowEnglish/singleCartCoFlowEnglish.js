...
import { OMNIDEF } from './singleCartCoFlowEnglish_def.js';
import tmpl from './singleCartCoFlowEnglish.html';
import tmpl_nds from './singleCartCoFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class singleCartCoFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
