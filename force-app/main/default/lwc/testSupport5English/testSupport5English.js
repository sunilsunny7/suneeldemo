...
import { OMNIDEF } from './testSupport5English_def.js';
import tmpl from './testSupport5English.html';
import tmpl_nds from './testSupport5English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testSupport5English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
