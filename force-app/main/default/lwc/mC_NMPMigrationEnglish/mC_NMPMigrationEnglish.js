...
import { OMNIDEF } from './mC_NMPMigrationEnglish_def.js';
import tmpl from './mC_NMPMigrationEnglish.html';
import tmpl_nds from './mC_NMPMigrationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class mC_NMPMigrationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
