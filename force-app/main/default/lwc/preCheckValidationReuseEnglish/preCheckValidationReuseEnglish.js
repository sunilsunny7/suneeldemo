...
import { OMNIDEF } from './preCheckValidationReuseEnglish_def.js';
import tmpl from './preCheckValidationReuseEnglish.html';
import tmpl_nds from './preCheckValidationReuseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class preCheckValidationReuseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
