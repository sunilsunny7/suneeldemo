...
import { OMNIDEF } from './orderSubmitOrderEnglish_def.js';
import tmpl from './orderSubmitOrderEnglish.html';
import tmpl_nds from './orderSubmitOrderEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class orderSubmitOrderEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
