...
import { OMNIDEF } from './mC_ConvergenceBenefitsTrackingEnglish_def.js';
import tmpl from './mC_ConvergenceBenefitsTrackingEnglish.html';
import tmpl_nds from './mC_ConvergenceBenefitsTrackingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class mC_ConvergenceBenefitsTrackingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
