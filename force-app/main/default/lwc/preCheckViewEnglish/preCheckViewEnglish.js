...
import { OMNIDEF } from './preCheckViewEnglish_def.js';
import tmpl from './preCheckViewEnglish.html';
import tmpl_nds from './preCheckViewEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class preCheckViewEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
