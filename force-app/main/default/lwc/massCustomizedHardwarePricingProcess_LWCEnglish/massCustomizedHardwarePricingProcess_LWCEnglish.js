...
import { OMNIDEF } from './massCustomizedHardwarePricingProcess_LWCEnglish_def.js';
import tmpl from './massCustomizedHardwarePricingProcess_LWCEnglish.html';
import tmpl_nds from './massCustomizedHardwarePricingProcess_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedHardwarePricingProcess_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
