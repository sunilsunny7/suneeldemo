...
import { OMNIDEF } from './massCustomizedQuantityCapture_AnanyaEnglish_def.js';
import tmpl from './massCustomizedQuantityCapture_AnanyaEnglish.html';
import tmpl_nds from './massCustomizedQuantityCapture_AnanyaEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedQuantityCapture_AnanyaEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
