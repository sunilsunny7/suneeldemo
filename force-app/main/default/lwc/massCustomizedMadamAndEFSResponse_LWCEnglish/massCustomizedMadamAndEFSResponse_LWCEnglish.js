...
import { OMNIDEF } from './massCustomizedMadamAndEFSResponse_LWCEnglish_def.js';
import tmpl from './massCustomizedMadamAndEFSResponse_LWCEnglish.html';
import tmpl_nds from './massCustomizedMadamAndEFSResponse_LWCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class massCustomizedMadamAndEFSResponse_LWCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
